...
/** WindowManager 事件清單 */
type WinEvent = 'window:opened' | 'window:closed' | 'window:focused' | 'window:minimized' | 'window:maximized' | 'window:restored' | 'window:maximized-drag-restored' | 'window:moved' | 'window:resized' | 'window:child-opened' | 'window:child-closed';
