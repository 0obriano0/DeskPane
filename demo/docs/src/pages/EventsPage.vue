...
const EVENT_DOCS = computed(() => [
  ...
  { name: 'window:drag-start', when: t('events.dragStart.when'), payload: 'WindowState' },
  { name: 'window:drag-end', when: t('events.dragEnd.when'), payload: 'WindowState' },
  { name: 'window:moved',     when: t('events.moved.when'),     payload: 'WindowState' },
  { name: 'window:resize-start', when: t('events.resizeStart.when'), payload: 'WindowState' },
  { name: 'window:resize-end', when: t('events.resizeEnd.when'), payload: 'WindowState' },
  { name: 'window:resized',   when: t('events.resized.when'),   payload: 'WindowState' },
  { name: 'window:edge-snap-preview', when: t('events.edgeSnapPreview.when'), payload: 'EdgeSnapPreviewEvent' },
  { name: 'window:edge-snap-preview-clear', when: t('events.edgeSnapPreviewClear.when'), payload: '{ id }' },
...
const EVENT_COLORS: Record<string, string> = {
  ...
  'window:drag-start': 'blue', 'window:drag-end': 'blue',
  'window:resize-start': 'orange', 'window:resize-end': 'orange',
  'window:edge-snap-preview': 'purple', 'window:edge-snap-preview-clear': 'purple',
...
const ALL_EVENTS: WinEvent[] = [
  ...
  'window:drag-start', 'window:drag-end', 'window:moved',
  'window:resize-start', 'window:resize-end', 'window:resized',
  'window:edge-snap-preview', 'window:edge-snap-preview-clear', 'window:edge-snapped',
...
const ALL_EVENTS: WinEvent[] = [
  ...
  'window:maximized-drag-restored',
  'window:drag-start', 'window:drag-end',
  'window:moved',
  'window:resize-start', 'window:resize-end',
  'window:resized',
